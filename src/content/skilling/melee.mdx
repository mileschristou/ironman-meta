---
title: "OSRS Ironman Melee Guide 1-99: Best Training Methods"
...
export const faqSchema = {
  ...
  mainEntity: [
    {
      '@type': 'Question',
      name: 'How do I start melee training efficiently?',
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'Do Waterfall Quest first - it takes 10-20 minutes and gives 13,750 Attack and 13,750 Strength XP, instantly reaching level 30. Safespot the Fire Giants with magic or ranged. This single quest skips 30 levels of grinding. After Waterfall, you are ready for Gemstone Crabs or Slayer depending on your goals.'
      }
    },
    {
      '@type': 'Question',
      name: 'Should I train with Gemstone Crabs or start Slayer early?',
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'Gemstone Crabs 30-70 (50-60k XP/hr, pure AFK, no cost) if you want relaxed training. Start Slayer at 40 if you want gear unlocks, but XP rates are slower pre-70. At 70+ Slayer, the XP rates (60-90k/hr) match crabs while unlocking critical equipment. Most ironmen do crabs to 70, then commit to Slayer for the Abyssal Whip at 85.'
      }
    },
    {
      '@type': 'Question',
      name: 'When is the Abyssal Whip unlock worth it?',
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'At 85 Slayer you unlock the Abyssal Whip - arguably the best melee weapon in the game until 78 Rapier (requires Theatre of Blood). The whip is worth grinding for because you will use it constantly from 85 onwards. By 85 Slayer, you are also making profit (task drops offset food costs) and the XP rates are competitive with pure AFK methods.'
      }
    },
    {
      '@type': 'Question',
      name: 'What is the endgame melee training method?',
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'Sulphur Naguas 85-99 (110-140k XP/hr, completely AFK, 10+ minutes per session). This is the fastest melee XP method, but requires 85+ stats to be efficient. Alternative: continue Slayer 85-99 for continued gear drops and endgame content unlocks. Choose Sulphur Naguas for pure speed, Slayer for resource gathering.'
      }
    },
    {
      '@type': 'Question',
      name: 'Is melee training expensive or profitable on ironman?',
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'Early game (quests + crabs) costs nothing - zero supplies needed. At 70+ Slayer, training becomes profitable because task drops (bones, herbs, salvageable gear) generate more value than food costs. By 75+ Slayer, you are typically making net profit while training. This is the ironman advantage over normal accounts.'
      }
    }
  ]
};
...
<TableOfContents items={[
  { label: "Quick Start: Three Phases of Melee", href: "#quick-start-three-phases-of-melee" },
  { label: "The Early Foundation: Quests That Skip 30 Levels", href: "#the-early-foundation-quests-that-skip-30-levels" },
  { label: "The Mid-Game Transition: From Crabs Through Slayer", href: "#the-mid-game-transition-from-crabs-through-slayer" },
  { label: "Method Comparison: When to Use Each Approach", href: "#method-comparison-when-to-use-each-approach" },
  { label: "Weapon Progression: Getting Better Gear When You Need It", href: "#weapon-progression-getting-better-gear-when-you-need-it" },
  { label: "Progression Flow: How It Actually Feels", href: "#progression-flow-how-it-actually-feels" },
  { label: "The Mid-Game Decision: Crabs vs. Slayer (The Gap Competitors Miss)", href: "#the-mid-game-decision-crabs-vs-slayer-the-gap-competitors-miss" },
  { label: "Weapon Progression Detail: Getting the Right Tool at the Right Time", href: "#weapon-progression-detail-getting-the-right-tool-at-the-right-time" },
  { label: "Armor Progression by Level", href: "#armor-progression-by-level" },
  { label: "Endgame AFK Options (85-99)", href: "#endgame-afk-options-85-99" },
  { label: "Cost Analysis: What Training Actually Costs", href: "#cost-analysis-what-training-actually-costs" },
  { label: "Synergies: What You're Unlocking Beyond XP", href: "#synergies-what-youre-unlocking-beyond-xp" },
  { label: "The Decision Framework: What Should YOU Train Right Now?", href: "#the-decision-framework-what-should-you-train-right-now" },
  { label: "Summary: The Ironman Melee Path", href: "#summary-the-ironman-melee-path" },
]} />
...
- [Slayer Guide](/skilling/slayer/) - Gear unlocks and XP from tasks; the core mid-game driver
- [Prayer Guide](/skilling/prayer/) - Piety gives +25% melee DPS and is essential for late-game efficiency
- [Gear Acquisition Guide](/supplies/gear-acquisition/) - How to obtain weapons, armour, and combat upgrades
- [Achievement Diary Guide](/guides/achievement-diaries/) - Diary rewards that directly boost melee and Slayer
- [Mid-Game Ironman Goals](/progression/mid-game-goals/) - Where melee fits into your broader account progression
- [Food Guide](/supplies/food/) - Supplies needed for Slayer tasks and bossing
