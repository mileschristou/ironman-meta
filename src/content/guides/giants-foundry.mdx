...
**Mistake Recovery:** If you do make a mistake (using the wrong tool for the temperature zone), you can recover lost quality by clicking the correct tool multiple times. This won't undo the initial -10 quality hit, but it will recover additional points if you get back on track quickly.

**Each mistake costs -10 quality.** A mistake is using the wrong tool for the current temperature zone. Quality directly translates to XP, so avoiding mistakes is more valuable than marginally better alloys. The good news: if you slip up, you can recover some of that lost quality by correcting your tool choice immediately.
